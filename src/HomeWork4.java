...
/*
 * Задание №1
 * ‼️ Нужно создать новый список, а не модифицировать старый ️‼️
 ...
 * Необходимо написать метод magSort(), который удалит из корзины все продукты весом больше 300.
 */
public class HomeWork4 {
    public static List<String> correctedList(List<String> stringList) {
        List<String> stringListNU = new ArrayList<>();
        for (String str : stringList) {
            ...
            if (!hasUppercase) {
                stringListNU.add(str);
            }
        }
        return stringListNU;
    }
    public static HashMap<String, Integer> magSort(HashMap<String, Integer> shopCart) {
        shopCart.entrySet().removeIf(stringIntegerEntry -> stringIntegerEntry.getValue() > 300);
        return shopCart;
    }
